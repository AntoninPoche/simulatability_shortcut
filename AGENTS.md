...
notebooks/
  ...
  6_judge_consistency.ipynb   # Prompt-prediction exact-agreement matrices (B1/B2/C1/C2/C3/A/R + gold + task-model) from data/predictions_*.csv
